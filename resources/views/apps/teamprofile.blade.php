            ...
            <div class="wight-bg">
                ...
                <div class="left-content ">
                    ...
                    <div class="row  ">
                        ...
                        <div class="col-md-6">
                            <ul class="list-inline team-list">
                                <li>
                                    <a href="">
                                        <div class="team-img" style="background: url({{ url('landingpage') }}/img/img2.png)  center"
                                ...
                                <li>
                                    <a href="">
                                        <div class="team-img" style="background: url({{ url('landingpage') }}/img/team1.png)  center"
                                ...
                                <li>
                                    <a href="">
                                        <div class="team-img" style="background: url({{ url('landingpage') }}/img/team2.png)  center"
                                ...
                                <li>
                                    <a href="">
                                        <div class="team-img" style="background: url({{ url('landingpage') }}/img/team3.png)  center"
                    ...
                    <div class="row  text-right">
                        <h3 class="text-right">
                            نبذة
                            <i class="fa fa-pencil-square-o" id="editdisc"  aria-hidden="true"></i>
                        ...
                        id="description" data-url="{{url('/app/updatemyteam')}}"  data-pk="{{ $team->id }}" data-type="textarea" data-placement="right" data-name="description"
                    ...
                    <div class="row  text-right">
                        ...
                        <div class="col-md-10">
                            ...
                            <select name="spical_id[]" class="list-inline skills" multiple placeholder="المهارات المطلوبة">
                            @foreach($skills as $skill)
                                <option value="{{ $skill->id }}"
                                    @foreach ($team->teamSkills as $teamskill)
                                        @if ( $teamskill->id === $skill->id)
                                            selected=""
                                        @else{
