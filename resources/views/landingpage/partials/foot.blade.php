...
<script>
    $(document).ready(function () {
        ...
        // start add valu to model
    $(document).ready(function () {
             $('#add-bart').click(function(){
...
<script type="text/javascript" src="{{ url('landingpage') }}/js/bootstrap-modal-popover.js"></script>
